...
export function atualizarLivro(id, titulo, autor, categoria, quantidade) {
  try {
    db.runSync(
      'UPDATE livros SET titulo = ?, autor = ?, categoria = ?, quantidade = ? WHERE id = ?',
      [titulo, autor, categoria, quantidade, id]
    );
